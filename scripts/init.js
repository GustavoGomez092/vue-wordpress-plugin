...
const intro = () => {
  console.log(chalk.hex('#3FB27F')('Welcome to the Vue WordPress Vite Plugin (VWVP) setup tool'));
  console.log(chalk.hex('#1C4F39')('This tool will help you setup your project'));
  console.log('');
}
...
const nameReplace = async (appName) => {
  ...
  const edit = filePath => {
    ...
    console.log(chalk.hex('#3FB27F')(`Edited file: ${filePath}`));
  };
